...
class ProjectTest extends CDbTestCase
{
    ...
    public function testCreate()
    {
        ...
        // ensure the user associated with creating the new project is the same as
        // the application user we set when saving the project
    ...
    public function testGetUserRoleOptions()
    {
        ...
        $this->assertTrue(is_array(Project::getUserRoleOptions()));
//        $this->assertTrue(count(Project::getUserRoleOptions()) > 0);
...
//        $this->assertTrue(array_key_exists('member', Project::getUserRoleOptions()));
//        $this->assertTrue(array_key_exists('owner', Project::getUserRoleOptions()));
//        $this->assertTrue(array_key_exists('reader', Project::getUserRoleOptions()));
    }
    ...
    public function testUserProjectAssignment()
    {
        $project = $this->projects('project2');
        $user = $this->users('user1');
        $logget_in_user = $this->users('user1');
        Yii::app()->user->setId($logget_in_user->id);
        $this->assertTrue($project->associateUserToProject($user));
        $this->assertTrue($project->isUserInProject($user));
        $this->assertTrue($project->deleteUserFromProject($user));
    }
