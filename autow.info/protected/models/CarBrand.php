 ...
 */
class CarBrand extends AutoWActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array(
                'id, name, description, logo, create_user_id, update_user_id, create_time, update_time',
                'safe',
                'on'=>'search'
            ),
		);
	...
	public function relations()
	{
		...
		return array(
			'carModels' => array(self::HAS_MANY, 'CarModel', 'car_brand_id'),
		);
	}
