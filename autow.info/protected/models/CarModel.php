 ...
 */
class CarModel extends AutoWActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('car_brand_id, name', 'required'),
			array('car_brand_id', 'numerical', 'integerOnly'=>true),
			array('name', 'length', 'max'=>128),
            array('description', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, car_brand_id, name, description', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'carGenerations' => array(self::HAS_MANY, 'CarGeneration', 'car_model_id'),
	...
	public function search()
	{
        ...
        $criteria->condition = 'car_brand_id=:carBrandID';
        $criteria->params = array(':carBrandID' => $this->car_brand_id);
